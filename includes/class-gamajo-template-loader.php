...
class Gamajo_Template_Loader {
	 ...
	 * @type string
	 */
	protected $filter_prefix = 'plugin_dir';
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'plugin-template-dir'; // or 'your-plugin-templates' etc.
	 ...
	 * @type string
	 */
	protected $plugin_directory = AASF_PLUGIN_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
